...
function template_main()
{
		...
		foreach ($context['boards'] as $board)
		{
			echo '
				<tr id="board_', $board['id'], '" class="windowbg2">
					<td class="icon windowbg child-icon"', !empty($board['children']) ? ' rowspan="2"' : '', '>
						<a href="', ($board['is_redirect'] || $context['user']['is_guest'] ? $board['href'] : $scripturl . '?action=unread;board=' . $board['id'] . '.0;children'), '">';

			// If the board or children is new, show an indicator.
			if ($board['new'] || $board['children_new'])
				echo '
							<svg class="star new-posts" viewBox="0 0 32 32" alt="New Posts" ><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#FullStar"></use></svg>';
			...
			// No new posts at all! The agony!!
				...
				echo '
							<svg class="star no-posts" viewBox="0 0 32 32" alt="No New Posts" ><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#NoStar"></use></svg>';
	...
	<div class="tborder topic_table" id="messageindex">
		...
		foreach ($context['topics'] as $topic)
		{
			...
			// We start with locked and 5c8cc topics.
            ...
            */
            ...
            echo	'<td class="stats ', $color_class, '">
					...
					<td class="lastpost ', $alternate_class, '">
                          <a class="skip" href="', $topic['last_post']['href'], '" title="Skip to final post">
                            <svg viewBox="0 0 32 32" ><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#ThreadBubble" alt="skip"></use><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#ThreadSkip" alt="skip"></use></svg>
                          </a>
	...
	<div class="tborder" id="topic_icons">
		<div class="description">
			<p id="message_index_jump_to" style="text-align:right;">&nbsp;</p>';

	if (!$context['no_topic_listing'])
		echo '

			<ul class="icon_glossary">', !empty($modSettings['enableParticipation']) && $context['user']['is_logged'] ? '
				' : '', '
                      <li>
